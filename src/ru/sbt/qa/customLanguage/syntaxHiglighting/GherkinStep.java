...
public interface GherkinStep extends GherkinPsiElement, GherkinSuppressionHolder, PomTarget, PsiNamedElement {
  ...
  /**
   * @return all step definitions (may be heavy). Works just like {@link ru.sbt.qa.customLanguage.steps.reference.CucumberStepReference#resolveToDefinition()}
   * @see ru.sbt.qa.customLanguage.steps.reference.CucumberStepReference#resolveToDefinition()
   */
  @NotNull
   ...
   * See {@link ru.sbt.qa.customLanguage.steps.AbstractStepDefinition#supportsRename(String)}.
