package ru.sbt.qa.customLanguage.steps;
...
import ru.sbt.qa.customLanguage.BDDFrameworkType;
import ru.sbt.qa.customLanguage.*;
import ru.sbt.qa.customLanguage.syntaxHiglighting.AbstractStepDefinition;
...
public class CucumberStepsIndex {
  ...
  public CucumberStepsIndex(final Project project) {
    myExtensionMap = new java.util.HashMap<>();
    myExtensionData = new java.util.HashMap<>();
   ...
   * More info is available in {@link #findStepDefinitions(com.intellij.psi.PsiFile, ru.sbt.qa.customLanguage.syntaxHiglighting.GherkinStep)} doc
   *
   * @param featureFile file with steps
   * @param step        step itself
   * @return definition or null if not found
   * @see #findStepDefinitions(com.intellij.psi.PsiFile, ru.sbt.qa.customLanguage.syntaxHiglighting.GherkinStep)
   */
  @Nullable
